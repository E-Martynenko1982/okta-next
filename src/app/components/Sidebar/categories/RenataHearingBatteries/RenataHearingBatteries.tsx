import ZincAir10Item from "./items/ZincAir10Item";
import ZincAir13Item from "./items/ZincAir13Item";
import ZincAir312Item from "./items/ZincAir312Item";
import ZincAir675Item from "./items/ZincAir675Item";

export default function RenataHearingBatteries() {
  return (
    <details className="group">
      <summary className="flex items-center bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg overflow-hidden transition-all cursor-pointer list-none">
        <div className="px-4 py-3 text-white/80 group-hover:text-white font-medium text-sm transition-colors flex-1">
          Батарейки для слухових апаратів RENATA
        </div>
